                    ...
                    {selectedRow?.status === 'pending' && (
                        <>
                            ...
                            <div className="button-container">
                                <Button onClick={() => handleRequestStatusChange('approved', selectedRow?.id)}>Approve Custom Realm</Button>
                                <Button variant='secondary' onClick={() => handleRequestStatusChange('declined', selectedRow?.id)}>Decline Custom Realm</Button>
                            </div>
                        </>
                    )}
